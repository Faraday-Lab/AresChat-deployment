<script lang="ts">
    ...
    import {VITE_GOOGLE_ID} from "$lib/actions/googleAuth";
...
<!--            <GoogleAuth clientId="746142593375-4bbme2dbm4m68jfgj0q86vfgkj19b29m.apps.googleusercontent.com" on:auth-success={e => console.dir(e.detail.user)} />-->
            </a>
