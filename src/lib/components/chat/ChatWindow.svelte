<script lang="ts">
    ...
    function questionYourFile(sourceID) {
        ...
        Swal.fire({
            ...
            // text: 'Ask a question about your file and we will answer it!',
            input: 'text',
            text: res,
            ...
            onRender: () => {
                ...
                dialog.setAttribute("id", "question-dialog");
            },
            preConfirm: (question) => {
                qstn = question;
                ...
                return axios
                    ...
                    .then((response) => {
                        ...
                        Swal.update({
                            title: qstn,
                            html: `<div>${response.data.content}</div>`,
                            showCancelButton: true,
        ...
        Swal.fire({
            ...
            if (result.isDenied) {
                Swal.fire({
                    ...
                    showCancelButton: true,
                    showDenyButton: true,
                    confirmButtonText: 'Sunrise in a forest',
                    denyButtonText: 'A dog with an helmet',
                    confirmButtonColor: '#C0C0C0',
                    cancelButtonColor: '#824348',
                    denyButtonColor: '#C0C0C0',
                    allowOutsideClick: true,
                    customClass: {
                        title: 'swal-white-title',
                        loader: 'swal-loading-spinner',
                        cancelButtonText: 'swal-white-text'
                    },
                    preConfirm: (prompt) => {
                        Swal.fire({
                            didOpen: () => {
                        ...
                        if (result.isConfirmed) {
                            generateImages('Sunrise in a forest');
                        }else{
                            generateImages('A dog with an helmet');
                        }
                    }
                )}
        })
        ...
        fetch(
            ...
            .then((responseJSON) => {
                ...
                Swal.fire({
                    ...
                    denyButtonText: "I have another prompt...",
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
        ...
        axios
            ...
            .then((response) => {
                ...
                Swal.fire({
                    ...
                    footer: '<a href="https://apod.nasa.gov/apod/astropix.html" target="_blank"><u>NASA\'s APOD</u></a>Each day, a new image from space with an astronomer\'s description <br>&copy; ' + response.data.copyright,
                })
            })
            .catch((error) => {
                console.log(error);
        ...
        >
            ...
            <div class="flex flex-row items-center justify-center space-x-3 mr-9 mt-1">
                <div>
                    ...
                    <form enctype="multipart/form-data" id="fileUploadForm" action="/chatpdf">
